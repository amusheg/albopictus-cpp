...
```{r echo=FALSE}
kable(rbind(prettify(anova(model1)), prettify(anova(model2)), prettify(anova(model3)), prettify(anova(model4))), digits=3)  
```
```{r echo=FALSE}
prev_year_plots
```
...
```{r echo=FALSE}
kable(prettify(anova(all_prevyear_model))) 
kable(prettify(anova(all_previnterval_model)))
