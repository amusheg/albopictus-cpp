...
ggplot(cpp_2, aes(x=lat, y=estimated_date, color=year)) + geom_point() + scale_y_date(date_breaks = "weeks" , date_minor_breaks="days", date_labels = "%b-%d") + facet_grid(~country) + theme_bw() + stat_smooth(method=lm, se=FALSE)
```
