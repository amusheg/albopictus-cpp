...
```
```{r}
ggplot(filter(gdd400_all, only_2008=="n", year!=2018), aes(x=latitude, y=gdd400, color=country)) + scale_color_manual(values=c("black", "gray"), name="Country") + geom_point() + facet_wrap(~year) + xlab("Latitude") + ylab("GDD Deadline (ordinal day)") + theme_bw() 
...
xlab("Week") + ylab("Diapause incidence")
